              ...
              <div className="py-6 flex flex-col gap-20 text-white w-full lg:w-1/2">
                <div className="w-full">
                  ...
                  <p className="font-lato text-lg ">
                    ...
                    democratize cargo transportation. By leveraging smart
                    shipment merging, we enable users who cannot afford
                    full-capacity freight to combine loads with others,
                    optimizing cost, space, and efficiency. From individual
                    shipments to multi-user cargo merges,CargoMerge bridges the
                    gap between capacity and affordability.
                  </p>
                </div>
                ...
                <div className="w-full ">
                  ...
                  <p className="font-lato text-lg ">
                    ...
                    merge requests — whether a transporter invites multiple
                    users to share space or a user requests to join an available
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 ">
              <div className="service">
                ...
                <p>
                  ...
                  costs while ensuring safe and timely delivery — whether
                  shipping by container or breakbulk.
                </p>
              </div>
              <div className="service">
                <div className="flex flex-col justify-center items-center">
                ...
                <p>
                  ...
                  CargoMerge, users can join or request logistics
                  collaborations, making inland freight more accessible and
                  efficient.
                </p>
              </div>
              <div className="service">
            ...
            <div className="py-6 flex flex-col gap-20 text-white w-full lg:w-1/2">
              <div className="w-full">
                ...
                <p className="font-lato text-lg ">
                  ...
                  ensuring every load finds the right partner. Whether you need
                  to move goods alone in a single shipment or combine your cargo
                  with others, CargoMerge brings the right people
                  together—faster, easier, and more efficiently. We don’t just
                  move cargo—we move opportunities.
                </p>
              </div>
              ...
              <div className="w-full ">
                ...
                <p className="font-lato text-lg ">
                  ...
                  uncertainty—get instant updates so you can book your shipment
                  at the perfect time. Our system connects you directly with
                  trusted transporters, ensuring you never miss an opportunity
                  to move your goods efficiently. Whether you’re shipping within
                  the city or across regions, you’ll have complete visibility
                  into availability, helping you plan ahead and save valuable
                  time.
                </p>
              </div>
              <div className="w-full ">
                ...
                <p className="font-lato text-lg ">
                  ...
                  ensuring you always know exactly where your shipment is and
                  when it will arrive. No guesswork—just complete transparency
